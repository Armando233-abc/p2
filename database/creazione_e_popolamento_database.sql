...
INSERT INTO `cliente` (`email`, `username`, `password`, `nome`, `cognome`, `data_nascita`, `is_admin`, `carta_credito`, `indirizzo`, `cap`)
VALUES 
('liviovona24@gmail.com', 'admin', SHA2('admin', 512), 'livio', 'vona', '2000-03-22', 1, '1111222233334444', 'Via G.Luigi X', '12345'),
('marco@gmail.com', 'user', SHA2('user', 512), 'marco', 'rossi', '2000-02-23', 0, '1111222233334444', 'Via G.Luigi X', '12345');
